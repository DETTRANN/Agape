  ...
  <body class="Nunito-Font">
    ...
    <main class="main-contact Nunito-Font">
      ...
      <div class="main-right-contact">
        ...
        <form action="#" method="get" class="form-contact" id="resetForm">
          <p>Email</p>
          <input 
            type="email" 
            name="email" 
          ...
          <button type="button" id="btn-reset-password" onclick="goToResetPassword()">
            Redefinir Senha
          </button>
          ...
          <div>
            ...
            <a href="{{url('views/login')}}" class="contact-text-color-form">
              Voltar para o Login
            </a>
          </div>
        </form>
