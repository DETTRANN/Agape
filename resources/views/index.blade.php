...
<body>
    ...
    <header id="header-menu">
        ...
        <div class="left-menu">
            <img src="{{url('frontend/img/logo-agape.png')}}" alt="" onclick="scrollToSection('.main-content')" />
    ...
    <main class="main-second-content">
        ...
        <nav class="nav-organizador-estoque-img">
            <img src="{{url('frontend/img/Captura_de_tela_2025-06-29_211831-removebg-preview.png')}}" alt="" />
        </nav>
    </main>
    ...
    <main class="main-sixth-content">
        <nav class="left-sixth-content">
            <img src="{{url('frontend/img/main-sixth-content-imagemmain-removebg-preview.png')}}   " alt="" />
        </nav>
