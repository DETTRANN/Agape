...
<body class="Nunito-Font">
    ...
    <main class="main-contact Nunito-Font">
        <div class="main-left-contact">
            <img id="img-contact" src="{{url('frontend/img/contact-image.png')}}" alt="Imagem de contato" />
        </div>
        ...
        <div class="main-right-contact">
            ...
            <form action="https://formsubmit.co/agapeinventory@gmail.com" method="POST" class="form-contact"
                id="contactForm">
                ...
                <div class="contact-name-form">
                    <div>
                        <p>Nome</p>
                        <input type="text" id="nome" name="nome" class="validacao" value="{{ old('nome') }}"
                            autocomplete="name" required />
                    </div>
                    <div>
                        <p>Email</p>
                        <input type="email" id="email" name="email" class="validacao" value="{{ old('email') }}"
                            autocomplete="email" required />
                    </div>
                </div>

                <p>Assunto</p>
                <input type="text" id="assunto" name="assunto" class="validacao" value="{{ old('assunto') }}"
                    autocomplete="off" required />

                <p>Mensagem</p>
                <textarea id="mensagem" name="mensagem" class="validacao" rows="5" autocomplete="off"
