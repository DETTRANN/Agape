  ...
  <body>
    <header id="header-menu">
      ...
      <div class="right-menu">
        ...
        <button onclick="goToCadastro()" type="submit" class="btn-cadastrar">Cadastrar</button>
      </div>
    ...
    <main class="main-login Nunito-Font">
      <div class="main-left-login">
        <img id="img-login" src="imgs/img-login.png" alt="" />
      </div>
        ...
        <form class="form-login" action="testLogin.php" method="POST">
          ...
          <div class="checkbox-login">
            ...
            <div>
              ...
              <a href="register.html" class="Login-text-color-form">
